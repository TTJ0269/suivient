@extends('layouts.apppositionnementmois')
            ...
            <div class="col-12 col-sm-5">
              <div class="form-group">
                  @foreach ($users as $user)
                    ...
                    <div class="">
                      <br>
                      <h5 class ="text-center" style="color:blue;">Livret de positionnement</h5>
                      ...
                      <h5 style="color:blue;">Date: <strong style="color:black;"> {{$format}} </strong> </h5>
                    </div>
                  @endforeach
              </div>
            </div>
           ...
           <div class="card card-info">
            ...
            @foreach ($collection_fonctions as $collection_fonction)
             ...
             @endforeach
                ...
                <div class="card card-info">
                  <div class="card-header">
                      <h3 class="card-title">SAVOIR ETRE</h3>
