      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('nombre_activiteget') }}" class="nav-link">
        ...
        <!--  <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('areaChart') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>area</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('dountChart') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>donut</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('radarChart') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>radar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('radialChart') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>radial</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('pileChart') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>pile</p>
                </a>
              </li>
