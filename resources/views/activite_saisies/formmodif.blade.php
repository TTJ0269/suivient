              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <div class="input-group mb-3">
                      ...
                      <textarea type="text" class="form-control @error('DescriptionActiviteSaisie') is-invalid @enderror" name="DescriptionActiviteSaisie" placeholder="Dèscription" autofocus  required>{{ $activite_saisy->DescriptionActiviteSaisie }}</textarea>
